...
export const profileService = {
  ...
  // A troca derruba os tokens antigos — inclusive o atual. O backend renova o
  // cookie httpOnly na resposta (Set-Cookie), então o usuário segue logado sem
  // que o front precise tocar em nada.
