        ...
        <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 items-stretch lg:items-center justify-between">
          ...
          <div className="flex gap-2 sm:gap-3">
            <button
              ...
              className="flex-1 lg:flex-none px-4 py-2.5 rounded-lg border border-[#B7294A] text-[#B7294A] hover:bg-[#B7294A] hover:text-white transition-colors whitespace-nowrap text-sm sm:text-base"
            >
              Importar alunos
            </button>
            ...
            <Button
              ...
              className="flex-1 lg:flex-none whitespace-nowrap !py-2.5 text-sm sm:text-base"
            >
              + Novo Usuário
            </Button>
          </div>
              ...
              <div key={user.id} className="p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-sm text-gray-600 break-all">{user.email || 'sem email'}</p>
                    {user.ra && <p className="text-xs text-gray-500 mt-0.5">RA {user.ra}</p>}
                  </div>
                ...
                {user.classGroupName && (
                  <p className="text-xs text-gray-600 mt-2">
                    {user.classGroupName}
                    {user.semester && ` · ${semesterLabel(user.semester)}`}
                    {user.courseName && <span className="text-gray-500"> · {user.courseName}</span>}
                  </p>
                )}
